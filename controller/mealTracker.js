...
export const addWeightToMeal = async (req, res) => {
    ...
    console.log("Back-end received:", req.body.city);

    const mealID = req.body.mealID
    const recipeName = req.body.recipeName
    const quantity = req.body.quantity;
    const userID = req.body.userID
    const geoCityFromLocation = req.body.cityName
   ...
   // const geoLocation = getCityFromCoordinates()
   //const getLocation = geoCityFromLocation

   //console.log(getLocation);

   // const fetchCity = await getCityFromCoordinates(latitude, longitude)
    ...
    //totalEnergiKjWithWeight = (quantity / 100)


    // const totalWeightOfTrackedMeal = quantity / 100 * totalEnergyKj

    // console.log("Back-end received:", totalWeightOfTrackedMeal);
    ...
    try {
        ...
        console.log("geoCityFromLocation:", geoCityFromLocation);
     ...
     const mealTracked = await index.connectedDatabase.postIntoDbMealTracker(userID, mealID, quantity, regTime, geoCityFromLocation, getTotalEnergyKj, getTotalProtein, getTotalFat, getTotalFiber, getTotalEnergyKcal, getTotalWater, getTotalDryMatter);
